...
def classify_position(pose_landmarks):
    ...
    if mode == 'push-up':
        ...
        feature_names = ["shoulder_hip_dist", "hip_knee_dist", "elbow_angle", "shoulder_foot_dist", "hip_angle", "knee_angle"]
        features = pd.DataFrame([[shoulder_hip_dist, hip_knee_dist, elbow_angle, shoulder_foot_dist, hip_angle, knee_angle]], columns=feature_names)
        clf = clf_yoga
