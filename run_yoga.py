...
clf_pushup  = joblib.load("classifier.pkl") 
clf_yoga = joblib.load("classifier_yoga.pkl") #! the trained model

def play_sound():
    """Play a sound when a push-up is detected."""
    pygame.mixer.init()  # Initialize the mixer
    pygame.mixer.music.load("/home/abdulkarim.alkhabour@Digital-Grenoble.local/Documents/advanced_computer_vision_2/projet/19_CampusPushUp/drum.wav")  # Ensure this file is in the same directory or provide full path
